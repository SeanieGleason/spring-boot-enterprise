...
package com.enterprise.build.publish;

import com.enterprise.build.ProjectLinks;
 ...
 *
 * <ul>
 * <li>If the {@code deploymentRepository} property has been set, a Maven artifact
 * repository is configured to publish to it it.
...
class MavenPublishingConventionsPlugin implements Plugin<Project> {
	...
	private void customizeOrganization(MavenPomOrganization organization) {
		organization.getName().set("Sean Gleason Software, Inc.");
		organization.getUrl().set("https://gleason.tech");
	}
	...
	private void customizeDevelopers(MavenPomDeveloperSpec developers) {
		developers.developer((developer) -> {
			developer.getId().set("gleasonsean");
			developer.getName().set("Sean Gleason");
			developer.getEmail().set("sean@gleason.tech");
		});
	}
